...
(function(exports) {
  ...
  var showStar = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at App line 31, column 1 - line 31, column 37: " + [ v.constructor.name ]);
  });
...
(function(exports) {
  ...
  var onEvent = function (v) {
          ...
          if (v instanceof BEditField) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(modifyEdit(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Component.BMark line 234, column 18 - line 240, column 36: " + [ v.value0.constructor.name ]);
              })()))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          ...
          throw new Error("Failed pattern match at Component.BMark line 196, column 3 - line 196, column 65: " + [ v.constructor.name ]);
      };
  ...
  var display = [ Halogen_HTML_Elements.div([ Util.class_("display") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(v.bm.url), Halogen_HTML_Properties.target("_blank"), Util.class_("link f5 lh-title" + Data_Monoid.guard(Data_Monoid.monoidString)(v.bm.toread)(" unread")) ])([ Halogen_HTML_Core.text((function () {
              ...
              return v.bm.title;
          })()) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(v.bm.url), Util.class_("link f7 gray hover-blue") ])([ Halogen_HTML_Core.text(v.bm.url) ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("http://archive.is/?run=1&url=" + Global_Unsafe.unsafeEncodeURIComponent(v.bm.url)), Util.class_("link f7 gray hover-blue ml2" + Data_Monoid.guard(Data_Monoid.monoidString)(Data_String_CodeUnits.contains("youtube")(v.bm.url))(" dn")), Halogen_HTML_Properties.target("_blank"), Halogen_HTML_Properties.title("archive link") ])([ Halogen_HTML_Core.text("\ud83d\uddc4") ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.div([ Util.class_("description mt1 mid-gray") ])(toTextarea(v.bm.description)), Halogen_HTML_Elements.div([ Util.class_("tags") ])(Data_Monoid.guard(Data_Monoid.monoidFn(Data_Monoid.monoidFn(Data_Monoid.monoidArray)))(!Data_String_Common["null"](v.bm.tags))(Data_Functor.map(Data_Functor.functorArray))(function (tag) {
      ...
      var onEvent = function (v) {
          ...
          if (v instanceof NEditField) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(modifyEdit(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Component.NList line 210, column 18 - line 212, column 32: " + [ v.value0.constructor.name ]);
              })()))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          ...
          throw new Error("Failed pattern match at Component.NList line 205, column 3 - line 205, column 61: " + [ v.constructor.name ]);
      };
