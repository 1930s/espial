...
(function(exports) {
  ...
  var showStar = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at App line 30, column 1 - line 30, column 37: " + [ v.constructor.name ]);
  });
  ...
  var fetchJson = function (dictWriteForeign) {
      return function (method) {
          return function (path) {
              return function (content) {
                  return function (rt) {
                      return fetchPath(method)(path)([ new Affjax_RequestHeader.ContentType(Data_MediaType_Common.applicationJSON) ])(Data_Functor.map(Data_Maybe.functorMaybe)(function ($5) {
                          return Affjax_RequestBody.string(Simple_JSON.writeJSON(dictWriteForeign)($5));
                      })(content))(rt);
                  };
              };
          };
...
(function(exports) {
  ...
  var nnote = function (st$prime) {
      var render = function (v) {
          ...
          var editField = function (f) {
              return function ($64) {
                  return Halogen_HTML_Events.input(NEditField.create)(f($64));
              };
          };
  ...
  var onEvent = function (v) {
          ...
          if (v instanceof NEditField) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(modifyEdit(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Component.NList line 203, column 18 - line 205, column 32: " + [ v.value0.constructor.name ]);
              })()))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(App.editNote(v1.edit_note)))(function (v2) {
                          ...
                          if (v2.body instanceof Data_Either.Right) {
                              var nt$prime = Data_Maybe.fromMaybe(v1.edit_note)(Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Argonaut_Core.toNumber(v2.body.value0))(Data_Int.fromNumber))(function (n) {
                                  return new Data_Maybe.Just({
                                      id: n,
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                  ...
                                  $53.edit = false;
                                  $53.note = nt$prime;
                                  $53.edit_note = nt$prime;
                                  return $53;
                              })()))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                              });
                          };
                          throw new Error("Failed pattern match at Component.NList line 236, column 5 - line 241, column 14: " + [ v2.body.constructor.name ]);
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Component.NList line 198, column 3 - line 198, column 61: " + [ v.constructor.name ]);
      };
      ...
      var render = function (v) {
          var renderNote = function (bm) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_(Data_Show.show(Data_Show.showInt)(bm.id)), Util.class_("note w-100 mw7 pa1 mb2") ])([ Halogen_HTML_Elements.div([ Util.class_("display") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(linkToFilterSingle(bm.id)), Halogen_HTML_Properties.target("_blank"), Util.class_("link f5 lh-title") ])([ Halogen_HTML_Core.text((function () {
                  var $62 = Data_String_Common["null"](bm.title);
                  if ($62) {
                      return "[no title]";
                  };
                  return bm.title;
