...
(function(exports) {
  ...
  var writeJSON = function (dictWriteForeign) {
      return function ($71) {
          return Global_Unsafe.unsafeStringify(writeImpl(dictWriteForeign)($71));
      };
  };
  var writeForeignString = new WriteForeign(Foreign.unsafeToForeign);
  var writeForeignNullable = function (dictWriteForeign) {
      return new WriteForeign(function ($73) {
          return Data_Maybe.maybe(Foreign.unsafeToForeign(Data_Nullable.toNullable(Data_Maybe.Nothing.value)))(writeImpl(dictWriteForeign))(Data_Nullable.toMaybe($73));
      });
  };
...
(function(exports) {
  ...
  var setInnerHtml = function (c) {
      return function (n) {
          return Control_Applicative.pure(Effect.applicativeEffect)($foreign._setInnerHtml(c, n));
      };
  };
  var setDataAttribute = function (k) {
      return function (v) {
          return function (n) {
              return Control_Applicative.pure(Effect.applicativeEffect)($foreign._setDataAttribute(k, v, n));
          };
      };
  };
  var moment8601 = function (s) {
      return Control_Applicative.pure(Effect.applicativeEffect)($foreign._moment8601(Data_Tuple.Tuple.create, s));
  };
  ...
  var innerHtml = function (n) {
      return Control_Applicative.pure(Effect.applicativeEffect)($foreign._innerHtml(n));
  };
  var getDataAttribute = function (k) {
      return function (n) {
          return Control_Applicative.pure(Effect.applicativeEffect)(Data_Nullable.toMaybe($foreign._getDataAttribute(k, n)));
      };
  };
  ...
  exports["_moment8601"] = $foreign._moment8601;
  exports["_mmoment8601"] = $foreign._mmoment8601;
  exports["_innerHtml"] = $foreign._innerHtml;
  exports["_setInnerHtml"] = $foreign._setInnerHtml;
  exports["_createFormData"] = $foreign._createFormData;
  exports["_createFormString"] = $foreign._createFormString;
  exports["_createFormArray"] = $foreign._createFormArray;
  exports["_getDataAttribute"] = $foreign._getDataAttribute;
  exports["_setDataAttribute"] = $foreign._setDataAttribute;
  exports["_closeWindow"] = $foreign._closeWindow;
})(PS["Globals"] = PS["Globals"] || {});
(function(exports) {
  /* global exports */
...
(function(exports) {
  ...
  var showStar = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at App line 29, column 1 - line 29, column 37: " + [ v.constructor.name ]);
  });
  ...
  var logoutE = function (e) {
      return Control_Bind.bindFlipped(Effect.bindEffect)(function ($4) {
          return Data_Functor["void"](Effect.functorEffect)(Effect_Aff.launchAff(logout($4)));
  ...
  var markRead = function (bid) {
      ...
      return fetchUrlEnc(Data_HTTP_Method.POST.value)(path)(Data_Maybe.Nothing.value)(Network_HTTP_Affjax_Response.ignore);
  };
  var toggleStar = function (bid) {
      return function (action) {
          var path = "bm/" + (Data_Show.show(Data_Show.showInt)(bid) + ("/" + Data_Show.show(showStar)(action)));
          return Data_Functor["void"](Effect_Aff.functorAff)(fetchUrlEnc(Data_HTTP_Method.POST.value)(path)(Data_Maybe.Nothing.value)(Network_HTTP_Affjax_Response.ignore));
      };
  };
  var fetchJson = function (dictWriteForeign) {
      return function (method) {
          return function (path) {
              return function (content) {
                  return function (rt) {
                      return fetchPath(method)(path)([ new Network_HTTP_RequestHeader.ContentType(Data_MediaType_Common.applicationJSON) ])(Data_Functor.map(Data_Maybe.functorMaybe)(function ($5) {
                          return Network_HTTP_Affjax_Request.string(Simple_JSON.writeJSON(dictWriteForeign)($5));
                      })(content))(rt);
                  };
              };
          };
  ...
  var editNote = function (bm) {
      return fetchJson(Model.note_wfI)(Data_HTTP_Method.POST.value)("api/note/add")(new Data_Maybe.Just(bm))(Network_HTTP_Affjax_Response.json);
  };
  var editBookmark = function (bm) {
      return fetchJson(Model.bookmark_wfI)(Data_HTTP_Method.POST.value)("api/add")(new Data_Maybe.Just(bm))(Network_HTTP_Affjax_Response.ignore);
  };
  var destroyNote = function (nid) {
      return fetchUrlEnc(Data_HTTP_Method.DELETE.value)("api/note/" + Data_Show.show(Data_Show.showInt)(nid))(Data_Maybe.Nothing.value)(Network_HTTP_Affjax_Response.ignore);
  };
  var destroy = function (bid) {
      return fetchUrlEnc(Data_HTTP_Method.DELETE.value)("bm/" + Data_Show.show(Data_Show.showInt)(bid))(Data_Maybe.Nothing.value)(Network_HTTP_Affjax_Response.ignore);
  };
  exports["Star"] = Star;
...
(function(exports) {
  ...
  // Halogen
  var class_ = function ($54) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($54));
  };
  var attr = function (a) {
  ...
  var _queryBoth$prime$prime = function (v) {
      return function (v1) {
          return function (f) {
              return function __do() {
                  var v2 = _querySelectorAll(v.value0)(v.value1)();
                  var v3 = _querySelectorAll(v1.value0)(v1.value1)();
                  return f(v2)(v3)();
              };
          };
      };
  ...
  var _queryBoth$prime = function (v) {
      return function (v1) {
          return function (f) {
              return function __do() {
                  var v2 = _querySelector(v.value0)(v.value1)();
                  var v3 = _querySelectorAll(v1.value0)(v1.value1)();
                  return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(v2)(function (a) {
                      return f(a)(v3);
                  })();
              };
          };
  ...
  var _queryBoth = function (v) {
      return function (v1) {
          return function (f) {
              return function __do() {
                  var v2 = _querySelector(v.value0)(v.value1)();
                  var v3 = _querySelector(v1.value0)(v1.value1)();
                  return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(v2)(function (a) {
                      return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(v3)(function (b) {
                          return f(a)(b);
                      });
                  })();
              };
  ...
  var _parseQueryString = function (srh) {
      var decode = function ($55) {
          return Global_Unsafe.unsafeDecodeURIComponent(Data_String_Common.replaceAll("+")(" ")($55));
      };
      var go = function (kv) {
  ...
  var _mt_pure = function ($56) {
      return Control_Monad_Maybe_Trans.MaybeT(Control_Applicative.pure(Effect.applicativeEffect)($56));
  };
  var _mt = Control_Monad_Maybe_Trans.MaybeT;
  var _lookupQueryStringValue = function (qs) {
      return function (k) {
          return Control_Bind.join(Data_Maybe.bindMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Tuple.snd)(Data_Foldable.find(Data_Foldable.foldableArray)(function ($57) {
              return (function (v) {
                  return v === k;
              })(Data_Tuple.fst($57));
          })(qs)));
  ...
  var _getElementById = function (s) {
      return function ($58) {
          return Web_DOM_NonElementParentNode.getElementById(s)(Web_DOM_Document.toNonElementParentNode(Web_HTML_HTMLDocument.toDocument($58)));
      };
  };
  ...
  var _body = Control_Bind.bindFlipped(Effect.bindEffect)(function ($59) {
      return Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.fromJust()($59));
  })(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_HTMLDocument.body)(_doc));
  exports["class_"] = class_;
  exports["attr"] = attr;
  exports["_queryBoth"] = _queryBoth;
  exports["_queryBoth'"] = _queryBoth$prime;
  exports["_queryBoth''"] = _queryBoth$prime$prime;
  exports["_querySelector"] = _querySelector;
  exports["_querySelectorAll"] = _querySelectorAll;
  exports["_fromNode"] = _fromNode;
  exports["_fromElement"] = _fromElement;
  exports["_getElementById"] = _getElementById;
  exports["_doc"] = _doc;
  exports["_loc"] = _loc;
  ...
  var addbmark = function (b$prime) {
      var render = function (v) {
          var toTextarea = function ($59) {
              ...
              })(Data_String_Common.split("\x0a")($59)));
          };
          var mmoment = Globals.mmoment8601(v.bm.time);
          var editField = function (f) {
              return function ($60) {
                  return Halogen_HTML_Events.input(BEditField.create)(f($60));
              };
          };
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof BEditField) {
              var modifyEdit = function (dictMonadState) {
                  return function (g) {
                      return Control_Monad_State_Class.modify_(dictMonadState)(function (s) {
                          ...
                          $36.edit_bm = g(s.edit_bm);
                          return $36;
                      });
                  };
              };
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(modifyEdit(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Component.Add line 156, column 18 - line 162, column 36: " + [ v.value0.constructor.name ]);
              })()))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v instanceof BEditSubmit) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.preventDefault(v.value0)))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(App.editBookmark(v1.edit_bm))))(function () {
          ...
          throw new Error("Failed pattern match at Component.Add line 146, column 3 - line 146, column 58: " + [ v.constructor.name ]);
      };
      var app = Globals["app'"](Data_Unit.unit);
  ...
  var bmark = function (b$prime) {
      var onEvent = function (v) {
          if (v instanceof BStar) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(App.toggleStar(v1.bm.bid)((function () {
                      if (v.value0) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          ...
                          $33.bm = (function () {
                              var $27 = {};
                              for (var $28 in v1.bm) {
                                  if ({}.hasOwnProperty.call(v1.bm, $28)) {
                                      $27[$28] = v1["bm"][$28];
                                  };
                              };
                              $27.selected = v.value0;
                              return $27;
                          })();
                          $33.edit_bm = (function () {
                              var $30 = {};
                              for (var $31 in v1.edit_bm) {
                                  if ({}.hasOwnProperty.call(v1.edit_bm, $31)) {
                                      $30[$31] = v1["edit_bm"][$31];
                                  };
                              };
          ...
          if (v instanceof BMarkRead) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(App.markRead(v1.bm.bid))))(function () {
                      var newState = (function () {
                          ...
                          $49.bm = (function () {
                              var $46 = {};
                              for (var $47 in v1.bm) {
                                  if ({}.hasOwnProperty.call(v1.bm, $47)) {
                                      $46[$47] = v1["bm"][$47];
                                  };
                              };
                              $46.toread = false;
          ...
          if (v instanceof BEditField) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(modifyEdit(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Component.BMark line 235, column 18 - line 241, column 36: " + [ v.value0.constructor.name ]);
              })()))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          ...
          throw new Error("Failed pattern match at Component.BMark line 197, column 3 - line 197, column 65: " + [ v.constructor.name ]);
      };
      var mkState = function (b) {
          return {
              bm: b,
      ...
      var render = function (v) {
          ...
          var linkToFilterTag = function (tag) {
              return app.userR + ("/t:" + tag);
          };
          var linkToFilterSingle = function (bid) {
              return app.userR + ("/b:" + Data_Show.show(Data_Show.showInt)(bid));
          };
          var editField = function (f) {
              return function ($82) {
                  return Halogen_HTML_Events.input(BEditField.create)(f($82));
              };
          };
          var display_edit = [ Halogen_HTML_Elements.div([ Util.class_("edit_bookmark_form pa2 bg-white") ])([ Halogen_HTML_Elements.form([ Halogen_HTML_Events.onSubmit(Halogen_HTML_Events.input(BEditSubmit.create)) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputUrl.value), Util.class_("url w-100 mt2 mb1 pt1 f7 edit_form_input"), Halogen_HTML_Properties.required(true), Halogen_HTML_Properties.name("url"), Halogen_HTML_Properties.value(v.edit_bm.url), Halogen_HTML_Events.onValueChange(editField(Eurl.create)) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Util.class_("title w-100 mt2 mb1 pt1 f7 edit_form_input"), Halogen_HTML_Properties.name("title"), Halogen_HTML_Properties.value(v.edit_bm.title), Halogen_HTML_Events.onValueChange(editField(Etitle.create)) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.p([ Util.class_("mt2 mb1") ])([ Halogen_HTML_Core.text(" description:") ]), Halogen_HTML_Elements.textarea([ Util.class_("description w-100 mt2 mb1 pt1 f7 edit_form_input"), Halogen_HTML_Properties.name("description"), Halogen_HTML_Properties.rows(5), Halogen_HTML_Properties.value(v.edit_bm.description), Halogen_HTML_Events.onValueChange(editField(Edescription.create)) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("tags_input_box") ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(" tags:") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Util.class_("tags w-100 mt2 mb1 pt1 f7 edit_form_input"), Halogen_HTML_Properties.name("tags"), Halogen_HTML_Properties.autocomplete(false), Util.attr("autocapitalize")("off"), Halogen_HTML_Properties.value(v.edit_bm.tags), Halogen_HTML_Events.onValueChange(editField(Etags.create)) ]), Halogen_HTML_Elements.br_ ]) ]), Halogen_HTML_Elements.div([ Util.class_("edit_form_checkboxes mv3") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Util.class_("private pointer"), Halogen_HTML_Properties.id_("edit_private"), Halogen_HTML_Properties.name("private"), Halogen_HTML_Properties.checked(v["edit_bm"]["private"]), Halogen_HTML_Events.onChecked(editField(Eprivate.create)) ]), Halogen_HTML_Core.text(" "), Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("edit_private"), Util.class_("mr2") ])([ Halogen_HTML_Core.text("private") ]), Halogen_HTML_Core.text(" "), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Util.class_("toread pointer"), Halogen_HTML_Properties.id_("edit_toread"), Halogen_HTML_Properties.name("toread"), Halogen_HTML_Properties.checked(v.edit_bm.toread), Halogen_HTML_Events.onChecked(editField(Etoread.create)) ]), Halogen_HTML_Core.text(" "), Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("edit_toread") ])([ Halogen_HTML_Core.text("toread") ]), Halogen_HTML_Elements.br_ ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputSubmit.value), Util.class_("mr1 pv1 ph2 dark-gray ba b--moon-gray bg-near-white pointer rdim"), Halogen_HTML_Properties.value("save") ]), Halogen_HTML_Core.text(" "), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputReset.value), Util.class_("pv1 ph2 dark-gray ba b--moon-gray bg-near-white pointer rdim"), Halogen_HTML_Properties.value("cancel"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(BEdit.create(false))) ]) ]) ]) ];
          ...
          })(Data_String_Common.split(" ")(v.bm.tags))), Halogen_HTML_Elements.a([ Util.class_("link f7 dib gray w4"), Halogen_HTML_Properties.title(Data_Maybe.maybe(v.bm.time)(Data_Tuple.snd)(mmoment)), Halogen_HTML_Properties.href(linkToFilterSingle(v.bm.bid)) ])([ Halogen_HTML_Core.text(Data_Maybe.maybe("\xa0")(Data_Tuple.fst)(mmoment)) ]) ])(links)) ];
...
(function(exports) {
      ...
      var onEvent = function (v) {
          ...
          if (v instanceof NEditField) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(modifyEdit(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Component.NList line 202, column 18 - line 204, column 32: " + [ v.value0.constructor.name ]);
              })()))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          ...
          if (v instanceof NDestroy) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(App.destroyNote(v1.note.id))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          var $39 = {};
                          for (var $40 in v1) {
          ...
          if (v instanceof NEditSubmit) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.preventDefault(v.value0)))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(App.editNote(v1.edit_note)))(function (v2) {
                          var nt$prime = Data_Maybe.fromMaybe(v1.edit_note)(Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Argonaut_Core.toNumber(v2.response))(Data_Int.fromNumber))(function (n) {
                              return new Data_Maybe.Just({
                                  id: n,
                                  created: v1.edit_note.created,
                                  length: v1.edit_note.length,
                                  text: v1.edit_note.text,
                                  title: v1.edit_note.title,
                                  updated: v1.edit_note.updated
                              });
                          }));
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              var $51 = {};
          ...
          throw new Error("Failed pattern match at Component.NList line 197, column 3 - line 197, column 61: " + [ v.constructor.name ]);
      };
  ...
  var nlist = function (st$prime) {
      ...
      var app = Globals["app'"](Data_Unit.unit);
      var linkToFilterSingle = function (nid) {
          return app.userR + ("/notes/" + Data_Show.show(Data_Show.showInt)(nid));
      };
      var render = function (v) {
          var renderNote = function (bm) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_(Data_Show.show(Data_Show.showInt)(bm.id)), Util.class_("note w-100 mw7 pa1 mb2") ])([ Halogen_HTML_Elements.div([ Util.class_("display") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(linkToFilterSingle(bm.id)), Halogen_HTML_Properties.target("_blank"), Util.class_("link f5 lh-title") ])([ Halogen_HTML_Core.text((function () {
                  var $59 = Data_String_Common["null"](bm.title);
                  if ($59) {
                      return "[no title]";
                  };
                  return bm.title;
              })()) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.div([ Util.class_("description mt1 mid-gray") ])(toTextarea(Data_String_CodePoints.take(200)(bm.text))), Halogen_HTML_Elements.a([ Util.class_("link f7 dib gray w4"), Halogen_HTML_Properties.title(Data_Maybe.maybe(bm.created)(Data_Tuple.snd)(mmoment(bm))), Halogen_HTML_Properties.href(linkToFilterSingle(bm.id)) ])([ Halogen_HTML_Core.text(Data_Maybe.maybe("\xa0")(Data_Tuple.fst)(mmoment(bm))) ]) ]) ]);
          };
...
})(PS["Component.UserSettings"] = PS["Component.UserSettings"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Monad_Error_Class = PS["Control.Monad.Error.Class"];
...
(function(exports) {
  ...
  var Component_UserSettings = PS["Component.UserSettings"];
  var Control_Bind = PS["Control.Bind"];
  var Data_Foldable = PS["Data.Foldable"];
  var Data_Function = PS["Data.Function"];
  var Data_Functor = PS["Data.Functor"];
  ...
  var renderUserSettings = function (renderElSelector) {
      return function (userSettings) {
          return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement(renderElSelector))(Data_Foldable.traverse_(Effect_Aff.applicativeAff)(Data_Foldable.foldableMaybe)(function (el) {
              return Data_Functor["void"](Effect_Aff.functorAff)(Halogen_VDom_Driver.runUI(Component_UserSettings.usetting(userSettings))(Data_Unit.unit)(el));
          })));
      };
  };
  ...
  var renderNote = function (renderElSelector) {
      return function (note) {
          return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement(renderElSelector))(Data_Foldable.traverse_(Effect_Aff.applicativeAff)(Data_Foldable.foldableMaybe)(function (el) {
              return Data_Functor["void"](Effect_Aff.functorAff)(Halogen_VDom_Driver.runUI(Component_NList.nnote(note))(Data_Unit.unit)(el));
          })));
      };
  };
  ...
  exports["renderUserSettings"] = renderUserSettings;
